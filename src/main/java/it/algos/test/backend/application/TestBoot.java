package it.algos.test.backend.application;

import com.vaadin.flow.spring.annotation.SpringComponent;
import it.algos.test.backend.data.TestData;
import it.algos.test.backend.packages.Alfa;
import it.algos.test.ui.views.DeltaView;
import it.algos.test.ui.views.OmegaView;
...
public class TestBoot extends FlowBoot {
