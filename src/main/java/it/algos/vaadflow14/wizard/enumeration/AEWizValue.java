...
public enum AEWizValue {
    ...
    costante("Costanti", false, false, "Costanti con valore statico fisso e non modificabile."),
    calcolato("Calcolati", false, false, "Valori in base al programma in uso. Regolati automaticamente alla partenza di Wizard (prima dei dialoghi) e poi statici."),
    inserito("Inseriti", true, true, "Valori in base al project o al package selezionato. Inseriti dall'utente (con un combobox). Regolati all'uscita del dialogo."),
    derivato("Derivati", false, true, "Valori in base al project o al package selezionato. Derivati automaticamente da un precedente valore inserito dall'utente."),
