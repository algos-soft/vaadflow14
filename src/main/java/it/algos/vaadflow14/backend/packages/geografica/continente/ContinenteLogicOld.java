...
import it.algos.vaadflow14.backend.packages.geografica.GeografiaLogicOld;
...
public class ContinenteLogicOld extends GeografiaLogicOld {
     ...
     */
    public ContinenteLogicOld(AIService entityService, AEOperation operationForm) {
