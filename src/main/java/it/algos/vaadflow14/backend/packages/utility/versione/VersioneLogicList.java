...
public class VersioneLogicList extends LogicList {
    ...
    protected void fixAlertList() {
        ...
        addSpanVerde(String.format("%s è una categorizzazione semplice di riferimento. Con %s selezionabile da menu.", type, filtro));
        addSpanVerde(String.format("%s è il numero della %s del JAR eseguibile.", numero,release));
