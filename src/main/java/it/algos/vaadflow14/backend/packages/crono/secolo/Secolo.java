...
@AIEntity(recordName = "Secolo", keyPropertyName = "secolo", usaIdTuttoMinuscolo = true, usaCaseInsensitive = true, usaBoot = true, usaNew = false, usaTimeStamp = false, usaNote = false)
