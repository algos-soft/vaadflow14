...
@AIEntity(recordName = "Mese", keyPropertyName = "mese", usaIdTuttoMinuscolo = true, usaCaseInsensitive = true, usaBoot = true, usaNew = false, usaTimeStamp = false, usaNote = false)
